...
//Prototype function used temporarily for testing the integration between forming the lunch partners
//and notifying them
...
//This is the answer formatting method.
//Participants receive a message if paired:
//'Hey @someone! You are paired up with @someone2 and @someone3 for lunch. Let's meet them at 12:45. Bon appétit!'
function sendMsg(name_list,time)
{
	var i;
	for(i=0;i<name_list.length;i++)
	{
		//The others array contains the people in the group besides the addressed person.
...
function createGroupsAndSend(time_array)
{
	for (var key in time_array)
	{
		...
		else
		{
			...
			// We couldn't decide how to handle this case properly.
...
{
	// Please note the 'ret' stands for return variable
	var ret={}; 
